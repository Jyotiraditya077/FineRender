      ...
      >
        ...
        >
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 leading-snug mb-1">
            Introducing the <span className="text-purple-600">AI-Powered</span><br className="hidden sm:block" />
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            ...
            <span className="text-pink-600 font-medium"> character designs</span> and even concepts that don’t yet exist —
